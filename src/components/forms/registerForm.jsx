...
export const RegisterForm  = () => {
    ...
    return(
        ...
        <div className="form-group">
          ...
          <input type="text" id="np" name="np" value={formData.np} onChange={handleChange} required />
        </div>
        <div className="form-group">
        ...
        <div className="form-group" id="apellidos">
          <label htmlFor="primerApellido">Primer Apellido: <input type="text" id="primerApellido" name="primerApellido" value={formData.primerApellido} onChange={handleChange} required /></label>
          <label htmlFor="segundoApellido">Segundo Apellido: <input type="text" id="segundoApellido" name="segundoApellido" value={formData.segundoApellido} onChange={handleChange} required /></label>
        </div>
        <br />
